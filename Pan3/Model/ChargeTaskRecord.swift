...
public class ChargeTaskRecord: NSManagedObject {
    ...
    @NSManaged public var clientChargeID: String?
    ...
    @NSManaged public var addedRangeKm: Double
    @NSManaged public var chargedEnergyKwh: Double
    ...
    var kmGain: Int64 {
        if addedRangeKm > 0 {
            return Int64(addedRangeKm.rounded())
        }
        guard endTime != nil else { return 0 }
