...
public class TripRecord: NSManagedObject {
    ...
    @NSManaged public var clientTripID: String?
    ...
    @NSManaged public var drivingDurationMs: Int64
    @NSManaged public var energyConsumedKwh: Double
    @NSManaged public var parkedEnergyKwh: Double
    @NSManaged public var avgEnergyPer100Km: Double
    ...
    @NSManaged public var pointsCount: Int64
    ...
    var tripDuration: String {
        if drivingDurationMs > 0 {
            let totalSeconds = Int(drivingDurationMs / 1000)
    ...
    var energyEfficiency: Double {
        if avgEnergyPer100Km > 0 {
            return avgEnergyPer100Km
        }
