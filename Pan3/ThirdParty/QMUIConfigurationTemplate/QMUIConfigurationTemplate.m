...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarStyle = UIBarStyleBlack;                                      // NavBarStyle : UINavigationBar 的 barStyle
    QMUICMI.navBarTintColor = [UIColor labelColor];                             // NavBarTintColor : NavBarContainerClasses 里的 UINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = [UIColor labelColor];                            // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = nil;                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    QMUICMI.navBarLargeTitleColor = [UIColor labelColor];                       // NavBarLargeTitleColor : UINavigationBar 在大标题模式下的标题颜色
    ...
    QMUICMI.tabBarBackgroundImage = [UIImage new];                                        // TabBarBackgroundImage : UITabBar 的背景图
    if (@available(iOS 15.0, *)) {
    ...
    QMUICMI.tabBarItemTitleColorSelected = [UIColor systemGreenColor];                                 // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemImageColor = nil;                                         // TabBarItemImageColor : UITabBarItem 未选中时的图片颜色
    QMUICMI.tabBarItemImageColorSelected = [UIColor systemGreenColor];                                 // TabBarItemImageColorSelected : UITabBarItem 选中时的图片颜色
